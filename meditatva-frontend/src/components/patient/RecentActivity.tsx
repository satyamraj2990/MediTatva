...
const activities = [
  {
    icon: ShoppingCart,
    titleKey: "recent.paracetamol",
    timeKey: "recent.time2h",
    color: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/30"
  },
  {
    icon: Calendar,
    titleKey: "recent.appointment",
    timeKey: "recent.timeYesterday",
    color: "text-blue-600 bg-blue-50 dark:bg-blue-950/30"
  },
  {
    icon: Camera,
    titleKey: "recent.uploadedPrescription",
    timeKey: "recent.time2d",
    color: "text-pink-600 bg-pink-50 dark:bg-pink-950/30"
  },
  {
    icon: Bell,
    titleKey: "recent.reminderSet",
    timeKey: "recent.time3d",
  ...
  return (
    <Card className="p-6 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-gray-200/50 dark:border-gray-800/50">
      <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">
        {t("recent.title", "Recent Activity")}
      </h3>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-900 dark:text-white">
                {t(activity.titleKey, activity.titleKey)}
              </p>
              <p className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1 mt-0.5">
                <span className="inline-block w-1 h-1 bg-gray-400 rounded-full"></span>
                {t(activity.timeKey, activity.timeKey)}
              </p>
            </div>
          </motion.div>
        ))}
